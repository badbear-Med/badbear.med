(() => {
  ...
  app.innerHTML = `
    ...
    <section class="tema-hero">
      ...
      <div><span>${tema.area.toUpperCase()} · NEUROLOGÍA</span><h1>${tema.titulo}</h1><p>${tema.descripcion}</p></div>
    </section>
      ...
      <div>
        <section class="tema-card">
          ...
          <ul>
            ...
            <li>Localización neuroanatómica y fisiopatología.</li>
            <li>Presentación clínica y signos de alarma.</li>
            <li>Diagnóstico y diagnóstico diferencial.</li>
            <li>Tratamiento, seguimiento y prevención cuando corresponda.</li>
